...
/// Hosted symbol for Host.measure_start!
pub extern fn roc_measure_start() callconv(.c) u8;

/// Hosted symbol for Host.measure_finish!
pub extern fn roc_measure_finish(arg0: u64) callconv(.c) RocStr;
