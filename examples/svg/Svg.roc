...
Svg :: {}.{
	...
	line = |x1, y1, x2, y2, style| {
		...
		\\<line x1="${x1.to_str()}" y1="${y1.to_str()}" x2="${x2.to_str()}" y2="${y2.to_str()}" stroke="${style.stroke}" stroke-width="${style.stroke_width.to_str()}"${marker} />
	}
	...
	polyline = |points, style| {
		...
		\\<polyline points="${coords}" fill="none" stroke="${style.stroke}" stroke-width="${style.stroke_width.to_str()}"${marker} />
	}
...
expect Svg.line(0, 0, 10, 10, Svg.default_line_style) == "<line x1=\"0\" y1=\"0\" x2=\"10\" y2=\"10\" stroke=\"#64748b\" stroke-width=\"1.5\" />"

## A line with a marker references it by id.
expect Svg.line(0, 0, 10, 10, { ..Svg.default_line_style, marker_end: "arrow" }) == "<line x1=\"0\" y1=\"0\" x2=\"10\" y2=\"10\" stroke=\"#64748b\" stroke-width=\"1.5\" marker-end=\"url(#arrow)\" />"
